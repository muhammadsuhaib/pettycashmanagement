...
Route::get('/openingamount','OpeningAmountController@index');
...
Route::get('/pettycasha/datatable', 'PettyCashFormAController@data_table');



Route::resource('/pettycashb', 'PettyCashFormbController');
Route::post('/transaction','PettyCashFormbController@store');
