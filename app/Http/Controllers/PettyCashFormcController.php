...
//        return dd($search);
            ...
            return view('pettycash.formc', compact('data','opening_amount', 'total_payment', 'carry_over_amount', 'total_recieved_money', 'balance', 'search'));
        } else {
    ...
    public function store(Request $request)
    {
        ...
        $total_received_amount = PettyCashTransaction::where
        ('created_at', 'like', '%' . $request->bdaymonth . '%')
            ->where('branch_id', Sentinel::getUser()->branch_id)
            ->where('checker_status', '1')
        ...
        return view('pettycash.transaction', compact('total_payment','total_received_amount','deficiency_amount','total_recieved_money','carry_over_amount','balance'));
